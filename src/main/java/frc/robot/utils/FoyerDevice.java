...
public class FoyerDevice {
    ...
    /**
     * Determines whether the through-bore encoder is transmitting.
    ...
    */
    public boolean isEncoderConnected() {
        if (!m_can.readPacketLatest(0x53, m_data)) {
            ...
            long currentTime = (long)(Timer.getTimestamp() * 1_000_000);
            return (currentTime - m_data.timestamp) < 100_000;
        }
    }
}
